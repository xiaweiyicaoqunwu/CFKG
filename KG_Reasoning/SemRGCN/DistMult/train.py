...
# 引入模型
from model import RGCN_DistMult

# --- 配置 ---
DATA_DIR = "./DistMult/data"
HIDDEN_DIM = 128
BATCH_SIZE = 1024
EPOCHS = 100
...
def train():
    ...
    # --- 模型 ---
    model = RGCN_DistMult(num_nodes, num_rels, HIDDEN_DIM, pretrained_node_emb=pretrained_node_emb, pretrained_rel_emb=pretrained_rel_emb).to(DEVICE)
